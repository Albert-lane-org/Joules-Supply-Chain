  ...
  return (
    <div id="bit31-cli-console" className="space-y-4 font-mono text-xs">
      ...
      <div className="flex flex-wrap items-center gap-2 bg-slate-900/90 p-3 rounded-xl border border-slate-800">
        ...
        <button
          onClick={() => runQuickCommand('gh repo clone Albert-lane/GOOGLE-LLC-IS-ANTI-CONSUMER-v2')}
          className="rounded bg-slate-800 hover:bg-slate-700 text-teal-300 px-2.5 py-1 text-[11px] border border-slate-700 transition"
        >
          gh repo route v2
        </button>

        <button
          onClick={() => runQuickCommand('worker deploy')}
        ...
        <button
          onClick={() => runQuickCommand('validate jsonld workflow')}
