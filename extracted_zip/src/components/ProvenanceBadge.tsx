      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="p-2.5 rounded bg-slate-950/60 border border-slate-800/80">
          <div className="text-slate-500 flex items-center gap-1.5 mb-1">
            ...
            <span>Sovereign & Co-Architect</span>
          </div>
          <div className="font-semibold text-slate-100">{LANE_CONSTANTS.RIGHTS_HOLDER}</div>
          <div className="text-cyan-300 text-[10px] font-semibold">{LANE_CONSTANTS.CO_ARCHITECTURAL_OWNERSHIP}</div>
          <div className="text-red-400 text-[10px] font-semibold">Corporate Rights: NONE</div>
          <div className="text-teal-400 font-bold text-[10px] mt-1">{LANE_CONSTANTS.HASHTAGS}</div>
        </div>
